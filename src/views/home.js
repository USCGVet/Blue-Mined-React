...
const Home = (props) => {
  return (
    <div className="home-container">
      <Helmet>
        <title>Blue Mined</title>
        <meta property="og:title" content="Blue Mined" />
      </Helmet>
        ...
        <div className="home-cards-container">
          <div className="home-features-card">
            ...
            <div className="home-text-container">
              <span className="home-heading1 card-Heading">Feature One</span>
          ...
          <div className="home-features-card1">
            ...
            <div className="home-text-container1">
              <span className="home-heading2 card-Heading">Feature Two</span>
          ...
          <div className="home-features-card2">
            ...
            <div className="home-text-container2">
              <span className="home-heading3 card-Heading">Feature Three</span>
          ...
          <div className="home-features-card3">
            ...
            <div className="home-text-container3">
              <span className="home-heading4 card-Heading">Feature Four</span>
          ...
          <div className="home-features-card4">
            ...
            <div className="home-text-container4">
              <span className="home-heading5 card-Heading">Feature Five</span>
          ...
          <div className="home-features-card5">
            ...
            <div className="home-text-container5">
              <span className="home-heading6 card-Heading">Feature Six</span>
      ...
      <div className="home-team">
        <div className="home-heading-container2">
          <h1 className="home-text18 section-Heading">Meet the Founder</h1>
        ...
        <div className="home-cards-container2">
          <div className="home-team-card">
            <div className="home-avatar-container"></div>
            <span className="home-name card-Heading">founder</span>
          </div>
        </div>
      </div>
      ...
      <div className="home-get-in-touch">
        <div className="home-content-container6"></div>
      </div>
      <div className="home-section-separator3"></div>
      <div className="home-footer-container">
        <div className="home-footer">
          <div className="home-social-links">
            <svg viewBox="0 0 950.8571428571428 1024" className="home-icon44">
